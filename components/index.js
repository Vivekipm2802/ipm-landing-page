...
export default function Home() {
  ...
  const mentors = [
    {
      image:
        "https://www.ipmcareer.com/files/2016/11/Ashutosh-Sir-e1641723253112.jpg",
  ...
  const slides = [
    {
      image:
        "https://www.ipmcareer.com/files/2020/06/Website-Indoreq-scaled.jpg",
    },
    {
      image:
        "https://www.ipmcareer.com/files/2020/06/Rohtak-Results-Template-ooo-scaled.jpg",
    },
  ];
  ...
  async function triggerInterakt() {
    axios
      .post("https://cp.ipmcareer.com/api/interakt", {
        userId: Date.now(),
      ...
      <main className={styles.main}>
          ...
          <div className={styles.c2}>
            <div className={styles.formcont}>
              <h1 className={styles.team_heading}>
                Fill out the form to Schedule FREE 1-1 Consulation with an
                Expert
              </h1>
              <input
                name={"name"}
              ...
              />
              <a onClick={SubmitContact} className={styles.submit}>
                SUBMIT
              </a>
        ...
        >
          <div className={styles.parent}>
            <div className={styles.col1}>
              ...
              <ul>
                <li>
                  Many of our students have commented on how much they enjoy the
                  interactive nature of the classes, with a variety of
                  activities and group work that keeps them engaged and
                  motivated.
                </li>
                <li>
                  The feedback that we receive from our students consistently
                  highlights the supportive and inclusive culture of our school.
                  They feel welcomed and valued as members of our community, and
                  they appreciate the inclusive and respectful atmosphere that
                  our teachers create.
                </li>
                <li>
                  In addition to the positive comments about the classes
                  themselves, our students also often express appreciation for
                  the extra support that is available to them. Whether it&#39;s
                  through tutoring, office hours, or other resources, our
                  students know that they can get the help that they need to
                  succeed.
                </li>
                <li>
                  Overall, our students are extremely satisfied with the
                  education that they are receiving, and we are continually
                  working to improve and enhance the learning experience for all
                  of our students.
                </li>
              </ul>
            </div>
            <div className={styles.col2}>
              <div className={styles.yt}>
                <YouTube title="" videoId="bFszqpsA81g" opts={opts} />
              </div>
            </div>
          </div>
        </Section>
        ...
        >
          <img
            ...
            src={
              "https://www.ipmcareer.com/files/2020/06/Rohtak-Results-Template-3updated-1-scaled.jpg"
            }
          />
        </Section>
        <Section
