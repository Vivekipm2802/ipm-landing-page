...
const cities = [
  {
    ...
    branches:
    [{title:'Khapri',
    address:'1st Address: Sector No.27, Plot No. 48, Behind Govt. Engineering College, Punar Wasan, New Khapri Shankarpur Road, Khapri, Nagpur',
    contact:'+91 797 242 9252',
    centreDirector:{
      name:'Mr. Atul Anand Koche',
      image:'https://www.ipmcareer.com/wp-content/uploads/2023/11/WhatsApp-Image-2023-11-04-at-14.34.57_327cca1f.jpg',
    },
  },
  {title:'Trimurti Nagar',
    address:'3rd floor Chandrabhaga appartments, Sujata Layout, Deendayal Nagar, London Street, Trimurti nagar, Nagpur, Maharashtra 440022',
    ...
    {title:'Bezonbagh',
    address:'Croffleto Cafe, Ginger Mall, Jaripatka Cement Rd, beside Caliber Net Cafe, opposite Embellish Unisex Salon, Bezonbagh, Nagpur, Maharashtra 440014',
  ...
  centreDirector:{
    ...
    badges:['One-on-One Mentorship Sessions by Experts','Classroom Experience for Better Studies'],
    slides:[{
        image:'/indore.png',
        alt:''
    }]
...

    {
      ...
      centreDirector:{
        ...
        slug:'lucknow',
        video:'https://www.youtube.com/embed/cuTKHzOIkfM',
        branches:[{title:'Hazratganj Branch',
        address:'2nd FLoor, Dube Chambers, Sapru Marg, above Mr. Brown Bakery,Prem Nagar, Hazratganj,Lucknow - 2260014',
...
centreDirector:{
  ...
  image:'https://www.ipmcareer.com/wp-content/uploads/2016/11/Ashutosh-Sir-e1641723253112.jpg',
        ...
        slug:'prayagraj',
        video:'https://www.youtube.com/embed/cuTKHzOIkfM',
        branches:[{title:'Prayagraj Branch',
        address:'1,Dr Lohia Road,Anant Kripa Balaji apartment next to Girls High School G.H.S. gate no.4, Civil Lines, Prayagraj, Uttar Pradesh',
      ...
      centreDirector:{
        ...
        slug:'mumbai',
        video:'https://www.youtube.com/embed/cuTKHzOIkfM',
        branches:[{title:'Mumbai Branch',
        address:'Caesars Court, 2nd Floor, 217, Swami Vivekananda Rd, above Paaneri, Andheri West, Mumbai, Maharashtra 400058',
      ...
      centreDirector2:{
        name:'Rishabh Singh',
        image:'https://www.ipmcareer.com/wp-content/uploads/2022/01/WhatsApp-Image-2022-01-09-at-4.49.41-PM-e1641850793724.jpeg',
        ...
        slug:'delhi',
        video:'https://www.youtube.com/embed/cuTKHzOIkfM',
        branches:[{title:'Connaught Place Branch',
        address:'9-A, Phelps Building, 2nd Floor, A Block, Middle Circle, Connaught Place, New Delhi - 110001',
        contact:'+91 90769 00940',
      centreDirector:{
        name:'Mr. Deepak Khushawa',
        image:'https://www.ipmcareer.com/wp-content/uploads/2016/11/deepak-kushwaha.jpg',
      },
      }],
        badges:['One-on-One Mentorship Sessions by Experts','Classroom Experience for Better Studies'],
        slides:[{
    ...
    },
    {
      ...
      slug:'pune',
      video:'https://www.youtube.com/embed/cuTKHzOIkfM',
      branches:[{title:'Pune Branch',
      address:'Office no. 8, 1st floor, Sagar Arcade building, besides Wadeshwar Restaurant, near Goodluck Chowk, Fergusson College Rd, Deccan Gymkhana, Pune, Maharashtra 411004',
...
useEffect(()=>{
    if( pageData && pageData.length > 0){}else{
...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke,type) {
...
async function SubmitContact(){
  ...
  if (!formData.city || formData.city.trim() === '') {
    ...
    triggerInterakt();
      /* await axios.post('/') */
      cronberryTrigger(formData.fullname,formData.email,formData.phone,formData.year,formData.city,'https://register.ipmcareer.com',formData?.type? formData.type : "" );
...
function validateEmail(email) {
  ...
  return (
    <>
     ...
     {pageData ?  <main className={styles.main}>
...
<div className={styles.heroo}>
    ...
    <h1>Preparation for <br/><span className={styles.color2}>IPMAT 2024/25 </span>{pageData.title == "Mumbai" ? <>& <span className={styles.color2}>NPAT</span></>:''} Now Offline<br/><span className={styles.color3}>At IPM Careers {pageData.title}</span></h1></div>
{pageData?.slug  == "nagpur" ? <h2 className={styles.npat}>IPMAT / NPAT / SET</h2>:''}
<div className={styles.branches}>
  
    {pageData && pageData.branches && pageData.branches.map((i,d)=>{
        return <div className={styles.branch}><h2>{i.title}</h2><p>Address:{i.address}</p>
        <h2>{i?.centreDirector?.role ?  i.centreDirector.role :"Centre Director"}</h2>
        <div className={styles.centre}><img src={i.centreDirector.image} width={'24px'} heigh={'24px'}/> <p>{i.centreDirector.name}</p></div>

{i?.centreDirector2? <>
  <h2>{i?.centreDirector2?.role ?  i.centreDirector2.role :"Centre Director"}</h2>
        <div className={styles.centre}><img src={i.centreDirector2.image} width={'24px'} heigh={'24px'}/> <p>{i.centreDirector2.name}</p></div></>

:""}

        <a href={`tel:${i.contact.split(' ').join('')}`}>Contact : {i.contact.split(' ').join('')}</a></div>
    })}


{pageData?.title == "Mumbai" ? <div className={styles.mumbai}>Now get Counselling <br/><span style={{color:"var(--brand-col2)"}}>done @ your doorstep</span></div>:''}
...
<p>You can now learn at India's Best IPMAT {pageData.title == "Mumbai" ? "& NPAT":''} Coaching in {pageData.title}. Hurry Up, Register Now !!</p>
{pageData.badges && pageData.badges.map((i,d)=>{
...
{pageData?.title == "Mumbai" ? <CustomSelect z={7} full="true" defaultText="How would you opt for counselling?" noPadding={true} objects={types} setSelect={(r)=>{setFormData(res=>({...res,type:r}))}}/>:''}
...
<p>Your Data is End-to-End Encrypted!</p>
          ...
          <img className={styles.rtop} src="https://www.ipmcareer.com/wp-content/uploads/2020/06/39-Selections-Web.jpg"/>
...
{d == 1 && pageData?.slug == "nagpur" ? <>
  ...
  <div alt={i.role} className={styles.bg} style={{backgroundImage:"url('/nagpur-univ.jpg')"}}></div>
  <img alt={i.fullname} src={'https://www.ipmcareer.com/wp-content/uploads/2023/11/WhatsApp-Image-2023-11-04-at-14.34.57_327cca1f.jpg'}/>
  <h2>Mr. Atul Anand Koche</h2>
  {i.role ? <p className={styles.para}>{'Director'}</p>:''}
  
</div>
<div className={styles.card}>
  <div alt={i.role} className={styles.bg} style={{backgroundImage:"url('/nagpur-univ.jpg')"}}></div>
  <img alt={i.fullname} src={'https://www.ipmcareer.com/wp-content/uploads/2023/11/WhatsApp-Image-2023-11-09-at-14.13.41_a8020b82.jpg'}/>
  <h2>Dr. Anand N. Shakya</h2>
  {i.role ? <p className={styles.para}>{'Senior Advision and Visiting Faculty'}</p>:''}
...
<div className={styles.rcard_profile}>
 ...
 <img alt="IPM Careers Rohtak Results"  className={styles.results} src={'https://www.ipmcareer.com/wp-content/uploads/2020/06/39-Selections-Web.jpg'}/>
