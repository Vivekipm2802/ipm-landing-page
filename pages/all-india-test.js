...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "#HASH IPMAT OPEN MOCk"
          }
      ]
  });
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2025/01/hp-web-size.jpg',
  alt:"IPM Careers Maha Scholarship Test "
},{
  image:'https://www.ipmcareer.com/wp-content/uploads/2025/01/hp-web-size.jpg',
  alt:'IPM Careers Maha Scholarship Test'
}]
...
<h1 className={styles.team_heading}>Register Now for #HASH IPMAT Open Mock</h1>
...
<p>Your Data is End-to-End Encrypted!</p>
       ...
       {/*  <Section title={"Overview of :All India Mock Test"} color="var(--brand-col1)" align="left">
<div className={styles.parent}>

<div className={styles.col2}>
<div className={styles.yt}>
<YouTube className='embed-container' title='' videoId="QOpB8ZHn45E" opts={opts}  /></div>
</div>
</div>
