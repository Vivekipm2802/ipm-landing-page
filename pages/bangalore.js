/**
 * register.ipmcareer.com/bangalore
 * Drop-in Next.js (pages router) page. Place at: pages/bangalore.js
 *
...
function RegistrationForm() {
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      {status === 'success' ? (
        <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-6 text-center text-green-400">
          <CheckCircle2 className="w-12 h-12 mx-auto mb-3 text-green-500" />
          <p className="font-bold text-lg">Registration Successful!</p>
          <p className="text-sm text-green-500/80 mt-1">Our team will contact you shortly to schedule your Strategy Session.</p>
          <button
            type="button"
            onClick={() => setStatus('idle')}
            className="text-white bg-green-600 hover:bg-green-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-4 transition-colors"
          >
        ...
        <section id="registration-form" className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 px-6 lg:px-12 bg-[#0F121E] text-white overflow-hidden">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg lg:text-xl leading-relaxed mb-6 max-w-lg">
              ...
              <div className="inline-flex items-center gap-2 text-sm text-gray-300 mb-10 bg-white/5 border border-white/10 rounded-full px-4 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#E89624]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                Now at 2 locations in Bangalore: <span className="font-bold text-white">Malleswaram</span> &amp; <span className="font-bold text-white">Jayanagar</span>
              </div>
            ...
            >
              ...
              <div className="bg-[#181D31] rounded-[2.5rem] p-8 lg:p-12 shadow-2xl relative z-10 border border-white/5">
                <h3 className="text-3xl font-bold font-heading mb-2">Join IPM Careers in Bangalore</h3>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
            ...
            >
              <div className="relative z-10 w-full max-w-lg mx-auto">
                <img src="https://res.cloudinary.com/duyo9pzxy/image/upload/v1780156918/Untitled_design_1_2_xukbx2.png" alt="IPM Careers Bangalore" className="w-full h-auto drop-shadow-2xl" />
              </div>

              {/* Mentor profile pop-in */}
              <div className="absolute -bottom-8 -left-4 lg:-left-10 z-30">
                <div className="bg-[#0F121E] text-white rounded-2xl p-5 shadow-2xl border border-white/10 max-w-[15rem]">
                  <div className="font-black font-heading text-lg leading-tight">Pranab Mehta</div>
                  <div className="text-[#E89624] text-[10px] font-bold tracking-widest uppercase mt-1">IIM Bangalore Alumnus</div>
                  <div className="text-sm text-gray-300 mt-1.5">25+ years of experience</div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-3">
                  <div className="bg-[#0F121E] text-white rounded-2xl p-4 pr-8 flex items-center gap-4 shadow-xl mb-2">
                    ...
                    <div>
                      ...
                      <a href="tel:+919379016193" className="text-2xl font-black font-heading mt-0.5 flex items-center gap-3 hover:text-[#E89624] transition-colors">93790 16193 <ArrowRight className="w-4 h-4 text-white/40" /></a>
                    </div>
                  </div>
                  <div className="bg-[#25D366] text-white rounded-2xl p-4 pr-8 flex items-center gap-4 shadow-xl">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/919379016193" target="_blank" rel="noopener noreferrer" className="text-2xl font-black font-heading mt-0.5 flex items-center gap-3 hover:text-white/80 transition-colors">93790 16193 <ArrowRight className="w-4 h-4 text-white/40" /></a>
                    </div>
                  </div>
                </div>
              </div>
