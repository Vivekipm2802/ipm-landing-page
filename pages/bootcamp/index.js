...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "Bootcamp Landing Page"
          }
      ]
  });
...
const mentors=[
  ...
  },
  {
    ...
    image:'https://ipmcareer.com/all-india-mock/wp-content/uploads/2023/06/manish.jpeg',
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2020/06/bootcamp-web-size-.jpg',
...
<h1 className={styles.team_heading}>Fill out the form to Register yourself in this Bootcamp</h1>
...
<YouTube className='embed-container' title='' videoId="6ZsYsn-ykpk" opts={opts}  /></div>
</div>
</div>
