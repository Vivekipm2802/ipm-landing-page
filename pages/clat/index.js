...
import styles from './Clat.module.css'
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2024/12/clat-web-size-copy.jpg',
...
<h1 className={styles.team_heading}>Fill out the form to Register for Mastering IPMAT Batch</h1>
