...
const testimonials =[{
  ...
  },
  {
    ...
    heading: 'Practice Tests and Mock Exams'
  },
  {
    icon: 'https://ipmcareer.com/wp-content/uploads/2023/01/professsor-1.png',
    heading: 'Strategic Exam Strategies'
  },
  {
...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "IPMAT Special Revision"
          }
      ]
  });
  ...
  xhr.addEventListener("readystatechange", function() {
      ...
      if (this.readyState === 4) {
          ...
          setSubmitted(true)
          router.push('https://rzp.io/l/vBH9eiDe6h')
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2024/05/special.revision.web_.size_.jpg',
  alt:"IPMAT Special Revision Batch"
},
{
  image:'https://www.ipmcareer.com/wp-content/uploads/2024/05/special.revision.web_.size_.jpg',
  alt:'IPMAT Special Revision Batch'
...
const reviews=[{
  ...
  review:'The comprehensive study material provided by IPMAT Essential was a game-changer for my preparation. It covered every aspect of the IPMAT exam, and the strategic exam strategies were incredibly helpful. The detailed performance analytics helped me track my progress, making my study sessions more efficient. Highly recommended!'
},{

  image:'https://www.ipmcareer.com/wp-content/uploads/2022/08/WhatsApp-Image-2022-07-30-at-8.26.20-PM.jpeg',
  fullname:'Juhi Mehra',
  college:'IIM Indore',
  title:'Fully Fledged Kit for IPMAT',
  review:"IPMAT Essential's AI-based test series is unparalleled. The practice tests and mock exams were not only challenging but also closely simulated the real IPMAT exam environment. This feature boosted my confidence and significantly improved my test-taking skills. If you want to ace the IPMAT, this is the study pack to go for."
},
{
  ...
  college:'IIM Indore',
  title:'Must have for Every IPMAT Student',
  review:'What sets IPMAT Essential apart is the one-on-one mentorship from IIMs graduates. The accessibility to doubt-clearing sessions was a game-changer for me. The support provided by experienced mentors was invaluable and made a significant difference in my preparation journey. I can confidently say that choosing IPMAT Essential was the best decision I made for my IPMAT preparation.'
}
]
...
city:formData.city,
year:formData.year,
source:'IPM Special Revision Page'
    }).select();
    if(data){
...
const includes = 
    [
        {
          "content": "Workshops form filling strategy by Ashutosh Mishra (IIM A Alumnus), Deepak Kushwaha (IIM L Alumnus), Aradhya Vats (IPM IIM Indore Gold Medalist), Rishabh Singh (IIFM Bhopal) & many more..",
          "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
        },
        {
          "content": "Make a decisive shift towards a dedicated IPMAT preparation environment",
          "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
        },
        {
          "content": "Expert Guidance from IPMAT Specialists",
          "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
        },
        {
          "content": "Interactive Sessions and doubt resolution",
          "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
        }, {
            "content": "Mock Analysis Sessions from Experts",
            "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
          },
          {
            "content": "Get Access to our Premium Test Series Hash IPMAT",
            "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
          },
          {
            "content": "One Weekly session from Experts",
            "icon": <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2Zm3.22 6.97-4.47 4.47-1.97-1.97a.75.75 0 0 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l5-5a.75.75 0 1 0-1.06-1.06Z" fill="var(--brand-col2)"/></svg>
          }
      ]
...
<h2>IPM Careers' <span style={{color:'var(--brand-col2)'}}>Special Revision Batch</span></h2>
{/* <p><span style={{color:'var(--brand-col2)'}}>If you are already preparing anywhere in any coaching.</span><br/> IPMAT Essential is a must have for all IPMAT Aspirants.</p> */}
...
<h2>Get it Now</h2>
<button className={styles.buynow} onClick={()=>{router.push('https://rzp.io/l/vBH9eiDe6h')}}>BUY NOW @ Rs.2999/-</button>



{/* <div className={styles.highlight}>
    <h2>
        Struggling to Find Right Direction in Your IPMAT Preparation ? <br/>
Low Mock Scores?  <br/>Limited Time?  <br/> </h2>

<h3>We Understand. <br/>IPMAT Essential- Your Guiding Light in Challenging Times.
</h3>
</div> */}
...
<h1 className={styles.team_heading}>Fill out the form to Register for <br/><span style={{color:"var(--brand-col2)"}}>Special Revision Batch</span></h1>
...
<div onClick={SubmitContact} className={styles.submit}>REGISTER NOW</div>
...
<p>Your Data is End-to-End Encrypted!</p>
          ...
          {/* <Section title={"Overview of:Special Revision Batch"} color="var(--brand-col2)" align="left">
<div className={styles.parent}>

<div className={styles.col2}>
<div className={styles.yt}>
<YouTube className='embed-container' title='' videoId="ymlhZDyybbw" opts={opts}  /></div>
</div>
</div>

        </Section> */}
         {/*  <Section title={"What's included in :IPMAT Essential?"} color="var(--brand-col2)" align="left" visible="true">
   <>
  {
    includes && includes.map((i,d)=>{
        return <div className={styles.point}>{i.icon}{i.content}</div>
    })
  }
</>
        ...
        <Section title={"Know : Your Mentors"} color="var(--brand-col2)" align="left">
...
return <div className={styles.card}>
  ...
  {i.role2 ? <p className={styles.para}>{i.role2}</p>:''}
   ...
   <Section title={"Why choose: Special Revision Batch?"} color="var(--brand-col1)" align="left" visible="true">
   <Swiper
     modules={[Navigation, Pagination, Autoplay]}
      spaceBetween={10}
