...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "Extended Crash Course"
          }
      ]
  });
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2024/01/extended-crash-course-website-copy.jpg',
...
city:formData.city,
year:formData.year,
source:'IPM Extended Crash Course'
    }).select();
    if(data){
...
<h1 className={styles.team_heading}>Fill out the details to Register for Extended Crash Course 2024</h1>
