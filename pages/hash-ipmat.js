...
export default function Home() {
  ...
  const mocks = [
    {
      ...
      image:
        "https://www.ipmcareer.com/wp-content/uploads/2022/05/Min-test.jpg",
      content:
        '<ul class="no-bullet arrow-starter"><li>10 IPM Mocks</li><li>5 JIPMAT Mock Test</li><li>5 Rohtak Mock Test</li>\r\n<li><span style="font-weight: 400;">In depth analysis for every mock</span></li>\r\n<li><span style="font-weight: 400;">Devise your own test taking strategy</span></li>\r\n</ul>',
    },
    {
  ...
  function cronberryTrigger(
    ...
    xhr.open(
      "POST",
      "https://api.cronberry.com/cronberry/api/campaign/register-audience-data"
    );
  ...
  const slides = [
    {
      image:
        "https://www.ipmcareer.com/wp-content/uploads/2020/06/hash-2.0-web-size-copy-1.jpg",
...
console.log("api")
 await axios.post('/api/hello',{
  ...
  const tabs = [
    "Auto-Generated Remedial Tests & Access to Learning Tools",
    "Weekly GK Tests -Current Affairs (On Mobile App)",
    "Performance Reports with In-depth Analysis & Benchmarking after Each Test",
  ];
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="IPM Careers HASH IPMAT Test for IPMAT Aspirants"
        />
      ...
      <main className={styles.main}>
        ...
        <div className={styles.mainimage}>
          <img src="https://www.ipmcareer.com/wp-content/uploads/2020/06/hash-2.0-web-size-copy-1.jpg" />
        </div>
...
{formData && Object.keys(formData).length*100/5 == 100 ?  <p style={{right:'0',left:'unset'}}>Done</p>:''}
            ...
            <h2 className={styles.more}>
              To Know more about our Premium Mock Test #Hash-IPMAT{" "}
              <svg
                width="24"
                height="24"
                fill="none"
          ...
          <div className={styles.c2}>
            <div className={styles.formcont}>
              <h1 className={styles.team_heading}>
                ...
                <span style={{ color: "var(--brand-col2)" }}>HASH IPMAT</span>
              </h1>
              <input
                name={"name"}
...
{mobile == "desktop" ?<img className={styles.imageblock} src={'https://www.ipmcareer.com/wp-content/uploads/2023/11/mock-website.jpg'}/> :''}
        ...
        <Section
          fullWidth
          title={"Premium Test Series Range:by IPM Careers"}
        ...
        >
          ...
          <div className={styles.cardshold}>
            {mocks &&
              mocks.map((i, d) => {
                return (
                  <div className={styles.tcard} href={i.link}>
                    <img src={i.image} />
                    {d == 2 ? (
                      <div className={styles.trust + " " + styles.best}>
                        Best Selling
                      </div>
                    ) : (
                      ""
                    ...
                    <a href={"https://study.ipmcareer.com/login"}>
                      FREE MOCK TEST
                    </a>
                  </div>
                );
        ...
        <Section
          title={"Why choose: IPM Careers' Mock Test?"}
          color="var(--brand-col1)"
          align="left"
          visible="true"
        >
