...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "Indore Landing Page"
          }
      ]
  });
...
<h2>IPM Careers Indore is waiting for you!!</h2>
<p>You can now learn at India's Best IPMAT Coaching in Indore. Hurry Up, Register Now !!</p>
<div className={styles.trust}>20% INAUGRAL DISCOUNT VALID TILL 10th FEB</div>
<div className={styles.trust}>5 One-on-One Sessions with Ashutosh Sir (3rd to 7th FEB)</div>
