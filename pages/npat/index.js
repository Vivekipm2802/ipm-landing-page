...
import {Button,Card,CardBody,CardHeader,CardFooter,Table, TableHeader, TableColumn, TableBody, TableRow, TableCell} from '@nextui-org/react'
...
const mentors=[
  ...
  },
  {
    ...
    image:'https://ipmcareer.com/all-india-mock/wp-content/uploads/manish.jpeg',
...
const faqs=[
    ...
    {
      question: "Is there a separate application form for NPAT, NMIMS CET, and NMIMS LAT?",
      answer:
...
const reviews=[{
  ...
  review:' IPM Careers provided exceptional NPAT coaching with dedicated instructors and effective study materials. Thanks to their support, I aced the NPAT exam.'
},{
  ...
  review:'I found IPM Careers helpful for NPAT prep, class sizes are managed well for more personalized attention.'
},
{
  ...
  review:'I had a very great experience during my NPAT Preparation , Teachers are so helpful'
}
]
...
const features = [<>Best & Promising<span className={styles.blue}>&nbsp;NPAT Results</span></>,<>Mentoring by<span className={styles.blue}>&nbsp;IIM Alumni</span></>,<>Awarded #1<span className={styles.blue}> by ZEE News</span></>,<>Gained Media Exposure for<span className={styles.blue}> Excellent Academic Performance</span></>];
...
<h1 className={styles.team_heading}>Fill out the form to Register for NPAT Crash Course</h1>
...
<CustomSelect z={9} full="true" defaultText="When are you planning to take NPAT?" noPadding={true} objects={Array(5).fill().map((i,d)=>{
...
})} setSelect={(r)=>{setFormData(res=>({...res,year:r}))}}/>
...
<div className={styles.rcard_profile}>
  <img alt={i.fullname} src={i.image}/>
   ...
   <Section>
<SyllabusSection syllabusData={quantitativeAptitudeData}></SyllabusSection>
...
<SyllabusSection syllabusData={lrData}></SyllabusSection>
 ...
 <img alt="IPM Careers Rohtak Results"  className={styles.results} src={'https://www.ipmcareer.com/wp-content/uploads/2023/10/NPAT-Results.jpg'}/>
...
const lrData = {
  ...
  topics: [
    ...
    },
    {
      ...
      subTopic: ["Be able to use the information given in graphs and charts to answer questions."],
    },
    {
  ...
  return (
    <div className="max-w-6xl !pt-12 mt-4 border-t-1 mx-auto p-0 md:p-4 space-y-8">
      <div className="space-y-4">
        <h1 className="text-3xl font-bold text-center text-primary">{syllabusData.title}</h1>
        <p className="text-muted-foreground text-sm text-center max-w-3xl mx-auto">{syllabusData.description}</p>
      </div>
...
const quantitativeAptitudeData = {
  ...
  topics: [
    ...
    {
      topic: "Algebra",
      subTopic: ["Basic Algebraic Identities, Equations- Linear & Quadratic Sequence, and Series (AP, GP)."],
    },
    {
      topic: "Sets and Functions",
      subTopic: ["Sets, Operation on Sets and their Applications using Venn Diagrams, functions."],
    },
    {
...
const verbalAbilityData = {
  ...
  topics: [
    ...
    },
    {
      ...
      subTopic: ["Using prepositions, determiners, connectives, and tenses adequately."],
    },
    {
      topic: "Vocabulary",
    ...
    },
    {
      ...
      subTopic: ["Putting ideas into logical sequence by putting jumbled sentences in the correct order."],
    },
    {
      topic: "Reading Comprehension (3 in Passages of 400-500 words with 5 Questions per Passage)",
      subTopic: [
