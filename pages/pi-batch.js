...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "PI Batch Landing Page"
          }
      ]
  });
  ...
  xhr.addEventListener("readystatechange", function() {
      ...
      if (this.readyState === 4) {
          ...
          setSubmitted(true)
          /* window.open('https://rzp.io/l/KBZTCMZ5vx','_blank') */
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2020/06/web-size-iim-sirmaur-copy.jpg',
...
<h1 className={styles.team_heading}>Fill out the form to register for Interview cum CV Preparation Batch</h1>
...
<p>Your Data is End-to-End Encrypted!</p>
          ...
          {/* <Section title={"Special PI Batch for :IPMAT 2024 Aspirants - Just Rs.99/-"} color="var(--brand-col1)" align="left" visible="true">

          <>
  <p>
    Are you an IPMAT 2024 aspirant aiming for success in your Personal Interview
    (PI)? Look no further! At IPM Careers, we are thrilled to announce a special
    PI batch exclusively for IPMAT 2024 candidates. This limited-time offer
    allows you to prepare under the expert guidance of alumni from prestigious
    institutions like IIMs, IITs, Harvard, and the University of Cambridge—all
    for just Rs. 99!
  </p>
  <h4>Why Choose Our Special PI Batch?</h4>
  <p>
    Preparing for the IPMAT Personal Interview can be daunting, but with the
    right guidance and preparation, you can excel. Our special PI batch is
    designed to provide you with unparalleled support and resources to help you
    succeed. Here’s why you should enroll:
  </p>
  <ol>
    <li>
      Expert Guidance: Learn from the best! Our mentors are alumni from top-tier
      institutions such as IIMs, IITs, Harvard, and the University of Cambridge.
      Their experience and insights will give you a competitive edge.
    </li>
    <li>
      Affordable: At just Rs. 99, this special batch is accessible to all
      aspirants, ensuring that financial constraints don’t come between you and
      your dreams.
    </li>
    <li>
      Comprehensive Preparation: Our program covers every aspect of the Personal
      Interview process, from understanding the panel’s expectations to
      mastering the art of self-presentation and answering tough questions.
    </li>
    <li>
      Personalized Feedback: Receive individualized feedback on your performance
      to help you identify strengths and areas for improvement.
    </li>
    <li>
      Mock Interviews: Participate in mock interviews that simulate the real
      experience, helping you to build confidence and reduce anxiety.
    </li>
    <li>
      Interactive Sessions: Engage in interactive sessions with your mentors,
      where you can ask questions and gain deeper insights into the PI process.
    </li>
  </ol>
  <h4>What You Will Learn</h4>
  <p>
    Our special PI batch covers a wide range of topics to ensure you are fully
    prepared:
  </p>
  <ul>
    <li>Self-Introduction: Craft a compelling and memorable introduction.</li>
    <li>
      Current Affairs: Stay updated with the latest news and learn how to
      discuss it confidently.
    </li>
    <li>
      Academic Background: Highlight your academic achievements effectively.
    </li>
    <li>
      Career Goals: Articulate your career aspirations and how the IPM program
      aligns with them.
    </li>
    <li>
      Behavioral Questions: Develop strategies to tackle common behavioral
      questions.
    </li>
    <li>
      Situation-Based Questions: Learn how to handle hypothetical scenarios with
      poise.
    </li>
    <li>
      Body Language: Understand the importance of non-verbal communication and
      how to use it to your advantage.
    </li>
  </ul>
  <h4>How to Enroll</h4>
  <p>Enrolling in our special PI batch is simple:</p>
  <ol>
    <li>
    ...
    <li>
      Register Online: Fill out the registration form with your details
      https://register.ipmcareer.com/pi-batch.
    </li>
    <li>Make Payment: Complete the payment process—just Rs. 99!</li>
    <li>
      Start Preparing: Once registered, you will receive access to our resources
      and session schedules.
    </li>
  </ol>
  <h4>Testimonials</h4>
  <p>
    Don’t just take our word for it. Here’s what some of our past students have
    to say:
  </p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  ...
  <h4>Conclusion</h4>
  <p>
    Don’t miss this incredible opportunity to prepare for your IPMAT 2024
    Personal Interview with the guidance of distinguished alumni from
    world-renowned institutions. For just Rs. 99, you can gain the skills and
    confidence needed to excel in your interview and secure your place in a top
    IPM program.
  </p>
  <p>
    Enroll today and take the first step towards a bright future with IPM
    Careers!
  </p>
  <p>
    For more information, visit our website or contact us at 8299470392 or mail
    at ipmcareeronline@gmail.com.
  </p>
</>

          </Section> */}

        <Section title={"Watch Out:Mock Interview"} color="var(--brand-col1)" align="left">
<div className={styles.parent}>

<div className={styles.col2}>
<div className={styles.yt}>
<YouTube className='embed-container' title='' videoId="oeWMXP9YbvM" opts={opts}  /></div>
</div>
</div>
...
<div className={styles.rcard_profile}>
 ...
 <img alt="IPM Careers Rohtak Results"  className={styles.results} src={result}/>
   ...
   <Section title={"Why you should join:a dedicated IPMAT Coaching?"} color="var(--brand-col2)" align="left" visible="true">
   <>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        That's a great decision if you're an IPMAT aspirant. Joining a dedicated
        IPMAT coaching program can provide you with structured preparation,
        expert guidance, and a competitive edge in your preparation for the
        IPMAT (Integrated Program in Management Aptitude Test). Here are some
  ...
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Research Coaching Institutes:</strong> Look for coaching
        institutes or online platforms that offer IPMAT coaching. Some
        well-known coaching institutes in India offer specialized courses for
        IPMAT. Do thorough research to find the one that suits your needs and
        preferences.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Check Reviews and Testimonials: </strong>Read reviews and
        testimonials from previous students to get an idea of the coaching
        institute's quality, teaching methods, and success rates.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Attend Demo Classes:</strong> Many coaching institutes offer
        demo classes to help you gauge their teaching style and faculty. Attend
        these classes to see if you are comfortable with the teaching methods
        and the faculty.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Assess the Faculty:</strong> It's important to have experienced
        and qualified faculty who can guide you through the IPMAT syllabus.
        Research the credentials of the faculty members at the coaching
        institute.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Course Curriculum:</strong> Check the course structure and
        curriculum. Ensure that it covers all the topics and sections of the
        IPMAT exam.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Study Material:</strong> Ask about the study materials provided
        by the coaching institute. Good study material is crucial for your
        preparation.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Mock Tests:</strong> Frequent mock tests and practice papers are
        essential for IPMAT preparation. Check if the coaching institute offers
        a sufficient number of mock tests.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Personalized Attention:</strong> Smaller batch sizes often mean
        more personalized attention. If you prefer one-on-one interaction,
        consider a coaching center with smaller classes.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Location and Accessibility:</strong> Consider the location of
        the coaching institute. It should be easily accessible from your home or
        place of stay.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Fees and Scholarships:</strong> Understand the fee structure and
        check if there are any scholarship options available.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Online vs. Offline:</strong> Decide whether you want to attend
        physical classes or prefer online coaching. Online coaching can offer
        flexibility, but physical classes can provide a more immersive learning
        experience.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Time Management:</strong> Ensure that the coaching class timings
  ...
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Plan Your Study Schedule:</strong> Once you join the coaching
        institute, make sure to create a study schedule that combines both
        classroom learning and self-study. Consistency is key.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Stay Committed:</strong> Stay dedicated and committed to your
        preparation. Your success depends on your effort and consistency.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        <strong>Stay Informed:</strong> Keep up with IPMAT updates and any
        changes in the exam pattern. The IPMAT exam may evolve, so make sure
        your coaching program adapts accordingly.
      </span>
    </span>
  </p>
  <p>
    <span style={{ fontSize: "11pt" }}>
      <span style={{ color: "#000000" }}>
        ...
        ultimately depends on your efforts and dedication. Make the most of your
        coaching program and ensure that you also engage in self-study and
        practice to excel in the IPMAT exam. Good luck with your preparation!
      </span>
    </span>
  </p>
  <p>&nbsp;</p>
