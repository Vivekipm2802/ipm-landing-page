...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "Prepare Landing Page"
          }
      ]
  });
...
const slides = [{
  image:'https://www.ipmcareer.com/wp-content/uploads/2024/02/Prepare-website-copy.jpg',
...
<h1 className={styles.team_heading}>Fill out the form to Register for Webinar</h1>
