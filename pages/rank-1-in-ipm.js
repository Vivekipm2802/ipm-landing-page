...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": "Rank 1 Aradhya Vats Landing Page"
          }
      ]
  });
...
const slides = [{
  image:'/secret.jpg',
  alt:"Secret to Crack IPMAT 2024"
}
]
const faqs=[
  {
...
city:formData.city,
year:formData.year,
source:'Rank 1 in IPM Register Page'
    }).select();
    if(data){
...
<h2>Secret to Crack IPMAT 2024 </h2>
<p> by a Gold Medalist 'Aradhya Vats' from IIM Indore</p>
<div className={styles.trust}>Exclusive Webinar for IPMAT Aspirants</div>
