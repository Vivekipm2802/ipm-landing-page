...
function Residential() {
  ...
  const slides = [
    {
      image:
        "https://www.ipmcareer.com/wp-content/uploads/2023/01/Website-Indoreq-scaled-_1_-_2_.webp",
      alt: "IPM Careers IIM Indore Results ",
    },
    {
      image:
        "https://www.ipmcareer.com/wp-content/uploads/2023/01/Rohtak-Results-Template-ooo-scaled-_1_.webp",
  ...
  const keys = [
    {
      image:
        "https://www.hiusa.org/wp-content/uploads/2020/04/sacramento-dorm-hiusa-1000x550-compressor-1-778x446.jpg",
    ...
    {
      image:
        "https://trainingindustry.com/content/uploads/2020/12/Project-Status-Meetings-12.2.20.jpg",
    ...
    {
      image:
        "https://www.cv-library.co.uk/career-advice/wp-content/uploads/2022/06/Blog-Popular-interview-questions.jpg",
    ...
    {
      image:
        "https://whatfix.com/blog/wp-content/uploads/2022/09/peer-learning.png",
      title: "Peer to Peer Learning",
    },
    {
      image:
        "https://images.squarespace-cdn.com/content/v1/537cad0be4b02cb9fe04985f/1426362641730-UOS11XMBBYB083ZCUGWF/Doubt.jpg",
  ...
  const hosts = [
    {
      image:
        "https://www.ipmcareer.com/wp-content/uploads/2023/06/WhatsApp-Image-2022-09-24-at-11.32.11-PM-e1687027784270.png",
  ...
  return (
    <>
      <Head>
        <link
          href="https://fonts.googleapis.com/css?family=Anek+Devanagari"
          rel="stylesheet"
        />
        <link
        ...
        <meta
          name="description"
          content="Now Learn at your favorite IPMAT Coaching IPM Careers."
        />
      </Head>
      {isSubmitted ? (
          ...
          <div className={styles.div1}>
            ...
            <div className={styles.badgewrap}>
              <p
                ...
                style={{
                  backgroundColor: "var(--brand-col1)",
                  color: "white",
                  marginRight: "10px",
                }}
              >
                Starting from 25th May 2024
              </p>
              <p className={styles.badge}>One on One Mentorship</p>
              <p className={styles.badge}>Mentorship by IIM Gold Medalist</p>
            </div>
            ...
            <p>
              Now Prepare better, Staying at IPM Careers around supervision of
              Mentors & Founders. <br />A Perfect Residential Batch for your
              IPMAT 2024 Exams.
            </p>
          </div>
          <div className={styles.div2}>
            <div className={styles.formcont}>
              <h1 className={styles.team_heading}>
                Register Now in Residential Batch at Kanpur Centre !! Limited
                Seats.
              </h1>
              <input
                name={"name"}
...
<p>Your Data is End-to-End Encrypted!</p>
        ...
        <h2 className={styles.hding}>
          Benefits bundled with this{" "}
          <span style={{ color: "var(--brand-col1)" }}>Residential Batch</span>
        </h2>
        <div className={styles.cardwrap}>
          {keys &&
            keys.map((i, d) => {
