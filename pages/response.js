...
function Response() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .on(
        ...
        (payload) => {
          toast.custom(
            <div className="flex flex-row items-center justify-start p-2 font-sans z-50 text-xs bg-white rounded-xl shadow-md">
              <Avatar src="https://t4.ftcdn.net/jpg/04/10/43/77/360_F_410437733_hdq4Q3QOH9uwh0mcqAhRFzOKfrCR24Ta.jpg"></Avatar>
              <div className="flex flex-col flex-1 ml-2">
                <h2 className="font-bold">
                  {payload.new.name} just generated scorecard
                </h2>
  ...
  async function getResponseSheetData(a) {
    ...
    if (!url || !validateURL(url.trim())) {
      setError(
        "Invalid URL Please Check Again , It should be a url to HTML of Response Sheet. For Example : https://iima.ac.in/responsesheet.html"
      );
...
:''} */}
      ...
      <script
        dangerouslySetInnerHTML={{
          __html:
            "window.url = 'https://cdn.digialm.com//per/g01/pub/1329/touchstone/AssessmentQPHTMLMode1/1329O221/1329O221S1D428/16568356269388104/AT2204080_1329O221S1D428E2.html#';",
        }}
      ></script>
      <NextSeo
        ...
        openGraph={{
          ...
          title: "IPMAT Score from Response Sheet - Best IPMAT Tool",
          description:
            "IPMAT Score from Response Sheet is a tool which can give you detailed analysis of your IPMAT response sheet in a matter of seconds.",
          images: [
            {
        ...
        <div className={styles.helpoverlay}>
          ...
          <div className={styles.helpmodal}>
            ...
            <p className={styles.errormsg}>
              It could be because of Invalid URL Please Check Again , It should
              be a url to HTML of Response Sheet. For Example :
              https://iima.ac.in/responsesheet.html
            </p>
            <p>OR</p>
        ...
        <div className={styles.leftcol}>
          ...
          <div className={styles.formsection}>
            <h1 className="text-3xl font-bold">
              <span style={{ color: "var(--brand-col1)" }}>IPMAT Score </span>
              <br />
              from Response Sheet
            </h1>
            <div className={styles.counter}>
              <strong>{index}</strong> IPMAT Heroes have already generated their
              Score Sheets since 2022. Now it's your turn.{" "}
              <span className={styles.counterbadge}>
                <a href="/topperlist">List of Toppers by IPMAT Score</a>
              </span>
            </div>
                ...
                topperslist.map((i, d) => {
                  return (
                    <div className={styles.toppers}>
                      ...
                      {d == 1 ? (
                        <div className={styles.award}>
                          <svg
                            ...
                            width="24px"
                            version="1.1"
                            viewBox="0 0 270.242 270.242"
                            enable-background="new 0 0 270.242 270.242"
                          >
                      ...
                      {i.our_student == true ? (
                        <div className="text-xs bg-secondary text-black rounded-full mx-2 px-2 py-1">
                          IPM Careers Student
                        </div>
                      ) : (
                        ""
            ...
            <div className={styles.inputsection}>
              <div className={styles.responseForm + " font-sans"}>
                ...
                <Input
                  ...
                  label="Response Sheet URL"
                  value={url ? url : ""}
                  onChange={(e) => {
                    setError(), setUrl(e.target.value);
                  }}
                />
                <p className="text-xs text-black rounded-xl border-1 border-yellow-500 bg-yellow-50 p-2 mt-2">
                  Please make sure to enter valid response sheet url , If your
                  scores are 0 then your response sheeet URL is invalid
                </p>
                <Spacer y={2}></Spacer>
                ...
                <Button
                  ...
                  isLoading={loading}
                  onPress={() => {
                    setDownloadLink(), setSent(false), getResponseSheetData();
                  }}
                >
                  Generate
                </Button>
                ...
                <>
                  <div className={styles.scorecard}>
                    ...
                    <div className={styles.scorewrapper}>
                      <div>
                        <h3>SA(QA)</h3>
                        <p>{calculateScores(data.sa, 0, 4)}</p>
                      </div>
                      <div>
                        <h3>MCQ(QA)</h3>
                        <p>{calculateScores(data.mcq, 1, 4)}</p>
                      </div>
                      <div>
                        <h3>VA(MCQ)</h3>
                        <p>{calculateScores(data.va, 1, 4, true)}</p>
                      </div>

                      <div>
                        <h3>Total</h3>
                        <p>
                          {calculateScores(data.sa, 0, 4) +
                            calculateScores(data.mcq, 1, 4) +
                            calculateScores(data.va, 1, 4, true)}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <ul>
                      <li>
                        ...
                        <a
                          ...
                          target="_blank"
                        >
                          https://www.iimidr.ac.in/academic-programmes/five-year-integrated-programme-in-management-ipm/ipm-admissions-details/
                        </a>
                      </li>
                      <li>
                        Click on <strong>“Candidate Response”</strong>
                      </li>
                      <li>
                        Right Click (or long press) to{" "}
                        <strong>Copy Link Address</strong>
                      </li>
                      <li>Paste the link in below (Enter File URL Field)</li>
                      <li>Click Submit</li>
                      <li>
                        Your Sectional and Cumulative Scores will be displayed
              ...
              <>
                {sent ? (
                  <p className={styles.sent}>
                    Detailed Scorecard has been sent to your email.
                  </p>
                ) : (
                  ""
                )}
          ...
          {downloadLink ? (
            <div
              className={styles.download + " " + styles.section}
              style={{ animationDelay: "100ms" }}
            >
              {secondDownloadLink ? (
                <>
                  <p className="!text-2xl font-bold">
                    Download your Full Scorecard Now
                  </p>
                  <div className={styles.spacer_x}></div>
                  <a href={secondDownloadLink} target="_blank">
          ...
          {downloadLink ? (
            <div
              className={styles.sharesection + " " + styles.section}
              style={{ animationDelay: "200ms" }}
            >
              <p className="!text-2xl font-bold">
                Share the Scorecard with your Friends
                <svg
                  width="24"
                  height="24"
                  fill="none"
              ...
              <ShareButton
                url={`https://register.ipmcareer.com${downloadLink}`}
              ></ShareButton>
            </div>
          ) : (
            ""
          ...
          <div className={styles.rightcol}>
            <div className={styles.banner + " aspect-[0.56/1]"}>
              ...
              <a
                ...
                target="_blank"
              >
                <button className={styles.button}>{config.bannerTitle}</button>
              </a>
            </div>
            <div className={styles.tools}>
              ...
              {config.tools &&
                config.tools.map((i, d) => {
                  return (
                    <a className={styles.tool} href={i.link}>
                      {i.title}
                    </a>
                  );
                })}
